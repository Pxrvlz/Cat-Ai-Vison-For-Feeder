 ...
 هدف اصلی این پروژه این است که تنها زمانی که گربه مورد نظر (گربه A یا B) به ظرف غذا نزدیک می‌شود، درب ظرف باز شود. این پروژه به شکلی ساده و دانشجویی پیاده‌سازی شده است تا مفاهیم پایه هوش مصنوعی را نشان دهد.
 ...
 ``` 
 *(اگر کارت گرافیک ندارید، برنامه به صورت خودکار روی CPU اجرا می‌شود اما ممکن است کمی کندتر باشد.)*
